        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8 text-right">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 justify-end mt-5">
              <a href="https://www.facebook.com/share/1BNVuxk5qA/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full flex items-center justify-center transition-all hover:scale-110" style={{ background: "rgba(196,149,106,0.2)", color: "var(--brand-gold)" }} aria-label="פייסבוק">
                <Facebook size={16} />
              </a>
              <a href="https://wa.me/9720542111288?text=%D7%A9%D7%9C%D7%95%D7%9D%20%D7%9E%D7%90%D7%99%D7%A8%2C%20%D7%90%D7%A9%D7%9E%D7%97%20%D7%9C%D7%A7%D7%91%D7%95%D7%A2%20%D7%A4%D7%92%D7%99%D7%A9%D7%AA%20%D7%99%D7%99%D7%A2%D7%95%D7%A5" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full flex items-center justify-center transition-all hover:scale-110" style={{ background: "rgba(37,211,102,0.2)", color: "#25D366" }} aria-label="וואטסאפ">
